...
import { Sparkles, Flame, Globe, Zap, BookOpen, Search, Check, ExternalLink } from 'lucide-react';
...
export const WebSearchConfigSection: React.FC<WebSearchConfigSectionProps> = ({
  webSearchProvider,
